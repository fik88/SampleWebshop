sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("cbsgmbh/webshop/WebShop/app", ".html");
		...
		return Opa5.extend("cbsgmbh.webshop.WebShop.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["cbsgmbh/webshop/WebShop/localService/mockserver"], function (mockserver) {
